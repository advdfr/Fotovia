...
public class WingsActivity extends BaseActivity implements MenuItemClickLister, OnClickListener {
    ...
    private LinearLayout linThirdDivisionOption,addtext, linEffect, linBackgroundBlur;
    ...
    private void Init() {
        ...
        addtext = (LinearLayout) findViewById(R.id.addtext);
    ...
    private void showColorPickerDialogDemo(int initialColor2,
        ...
        colorpickerView = new ColorPicker(WingsActivity.this);
        int initialColor = photoEditorApplication.getColor();
        final Dialog d = new Dialog(WingsActivity.this);
            ...
            public void onClick(View v) {
                try {
                    ...
                    if (!textSticker.isEmpty()) {
                        TextSticker sticker = new TextSticker(WingsActivity.this);

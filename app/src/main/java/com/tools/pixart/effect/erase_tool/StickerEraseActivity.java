package com.tools.pixart.effect.erase_tool;
...
import com.tools.pixart.effect.activity.BaseActivity;
import com.tools.pixart.effect.activity.DripEffectActivity;
import com.tools.pixart.effect.activity.FramesActivity;
import com.tools.pixart.effect.activity.NeonActivity;
import com.tools.pixart.effect.activity.WingsActivity;
import com.tools.pixart.effect.erase_tool.eraser.EraseSView;
import com.tools.pixart.effect.erase_tool.eraser.EraseView;
import com.tools.pixart.effect.erase_tool.eraser.EraseView.ActionListener;
import com.tools.pixart.effect.erase_tool.eraser.EraseView.UndoRedoListener;
import com.tools.pixart.effect.erase_tool.eraser.MultiTouchListener;
...
public class StickerEraseActivity extends BaseActivity implements OnClickListener {
    ...
    public void onClick(View view) {
        if (this.dv != null || view.getId() == R.id.btn_back) {
            ...
            String str2 = "";
            int id = view.getId();
            if (id == R.id.btn_auto || id == R.id.rel_auto_btn) {
            ...
            } else if (id == R.id.btn_erase || id == R.id.rel_erase_btn) {
            ...
            } else if (id == R.id.btn_lasso || id == R.id.rel_lasso_btn) {
            ...
            } else if (id == R.id.btn_restore || id == R.id.rel_restore_btn) {
            ...
            } else if (id == R.id.btn_zoom || id == R.id.rel_zoom_btn) {

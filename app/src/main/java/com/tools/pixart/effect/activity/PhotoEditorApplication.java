...
public class PhotoEditorApplication extends Application {
  ...
  //  public synchronized Tracker getGoogleAnalyticsTracker() {
    //    AnalyticsTrackerClass AnalyticsTrackerClass = com.example.valentinephotoframe.custom.AnalyticsTrackerClass.getInstance();
   //     return AnalyticsTrackerClass.get(com.example.valentinephotoframe.custom.AnalyticsTrackerClass.Target.APP);
  //  }
